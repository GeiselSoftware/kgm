...
def main():
    ...
    # mac: /usr/local/kgm/lib/python3.13/site-packages/kgm_editor/electron-dist/darwin-arm64
    # mac: ./kgm-editor.app/Contents/MacOS/Electron -- http://localhost:3030/kgm-default-dataset/query /gimp-test.shacl
    # import site; site.getsitepackages()
    #
    # /usr/local/kgm/lib/python3.13/site-packages/kgm_editor/electron-dist/darwin-arm64/kgm-editor.app/Contents/MacOS/Electron -- http://localhost:3030/kgm-default-dataset/query /gimp-test.shacl
    p = platform.system()
    if p == "Darwin":
        fuseki_query_url = "http://localhost:3030/kgm-default-dataset/query"
        kgm_path = sys.argv[1]
        electron_app_dir = os.path.join(site.getsitepackages()[0], "kgm_editor/electron-dist/darwin-arm64")

...
#ifdef __EMSCRIPTEN__
  io.Fonts->AddFontFromFileTTF("fonts/Play-Regular.ttf", 23.0f);
  io.Fonts->AddFontFromFileTTF("fonts/Play-Regular.ttf", 18.0f);
  io.Fonts->AddFontFromFileTTF("fonts/Play-Regular.ttf", 26.0f);
  io.Fonts->AddFontFromFileTTF("fonts/Play-Regular.ttf", 32.0f);
#else
